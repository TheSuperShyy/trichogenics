...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        display: ["clamp(3rem, 1.7rem + 6.4vw, 5.5rem)", { lineHeight: "1.05", letterSpacing: "-0.02em" }],
        h1: ["clamp(2.5rem, 1.7rem + 4vw, 4rem)", { lineHeight: "1.08", letterSpacing: "-0.015em" }],
        h2: ["clamp(2.125rem, 1.4rem + 3.4vw, 2.875rem)", { lineHeight: "1.1", letterSpacing: "-0.015em" }],
        h3: ["clamp(1.5rem, 1.2rem + 1.5vw, 2rem)", { lineHeight: "1.2" }],
        h4: ["clamp(1.25rem, 1.1rem + 0.7vw, 1.4375rem)", { lineHeight: "1.3" }],
        lead: ["clamp(1.25rem, 1.05rem + 0.9vw, 1.5rem)", { lineHeight: "1.6" }],
